...
if ( !empty($_POST)) { // if not first time through
	...
	if ($valid) {
		...
		$sql = "INSERT INTO as04_events (event_date, event_time, event_location, event_description) values(?, ?, ?, ?)";
		$q = $pdo->prepare($sql);
...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="as04_event_create.php" method="post">
