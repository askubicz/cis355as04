...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	if ($valid) { // if valid user input update the database
		...
		$sql = "UPDATE as04_assignments set assign_per_id = ?, assign_event_id = ? WHERE id = ?";
		$q = $pdo->prepare($sql);
		$q->execute(array($person,$event,$id));
		Database::disconnect();
		header("Location: as04_assignments.php");
	}
} else { // if $_POST NOT filled then pre-populate the form
	$pdo = Database::connect();
	$pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
	$sql = "SELECT * FROM as04_assignments where id = ?";
	$q = $pdo->prepare($sql);
	$q->execute(array($id));
...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="as04_assign_update.php?id=<?php echo $id?>" method="post">
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php
							$pdo = Database::connect();
							$sql = 'SELECT * FROM as04_persons ORDER BY lname ASC, fname ASC';
				...
				<div class="control-group">
					...
					<div class="controls">
						<?php
							$pdo = Database::connect();
							$sql = 'SELECT * FROM as04_events ORDER BY event_date ASC, event_time ASC';
				...
				<div class="form-actions">
					...
					<a class="btn" href="as04_assignments.php">Back</a>
				</div>
