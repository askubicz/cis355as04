...
if ( !empty($_POST)) { // if $_POST filled then process the form
	...
	# initialize/validate (same as file: as04_event_create.php)
	...
	if ($valid) { // if valid user input update the database
		...
		$sql = "UPDATE as04_events  set event_date = ?, event_time = ?, event_location = ?, event_description = ? WHERE id = ?";
		$q = $pdo->prepare($sql);
...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="as04_event_update.php?id=<?php echo $id?>" method="post">
