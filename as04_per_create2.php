...
if ( !empty($_POST)) { // if not first time through
	...
	if ($valid) 
	{
		...
		$sql = "INSERT INTO as04_persons (fname,lname,email,mobile,password,title,
...
<body>
    <div class="container">
		...
		<div class="span10 offset1">
			...
			<form class="form-horizontal" action="as04_per_create2.php" method="post" enctype="multipart/form-data">
				...
				<div class="form-actions">
					...
					<a class="btn" href="as04_events.php">Back</a>
				</div>
